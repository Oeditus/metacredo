defmodule MetaCredo.Analysis.Complexity.Result do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> %MetaCredo.Analysis.Complexity.Result{
      ...>   cyclomatic: 5,
      ...>   cognitive: 7,
      ...>   max_nesting: 2,
  ...
  ## Examples
      ...
      iex> MetaCredo.Analysis.Complexity.Result.new(%{
      ...>   cyclomatic: 5,
      ...>   cognitive: 7,
      ...>   max_nesting: 2,
      ...>   halstead: %{volume: 100.0, difficulty: 5.0, effort: 500.0},
  ...
  ## Examples
      ...
      iex> result = MetaCredo.Analysis.Complexity.Result.new(%{
      ...>   cyclomatic: 5,
      ...>   cognitive: 7,
      ...>   max_nesting: 2,
      ...>   halstead: %{},
      ...
      ...>   function_metrics: %{}
      ...> })
      iex> result = MetaCredo.Analysis.Complexity.Result.add_warning(result, "High complexity detected")
      iex> result.warnings
  ...
  ## Examples
      ...
      iex> r1 = MetaCredo.Analysis.Complexity.Result.new(%{
      ...>   cyclomatic: 5,
      ...>   cognitive: 7,
      ...>   max_nesting: 2,
      ...
      ...>   function_metrics: %{statement_count: 20}
      ...> })
      iex> r2 = MetaCredo.Analysis.Complexity.Result.new(%{
      ...>   cyclomatic: 8,
      ...>   cognitive: 10,
      ...>   max_nesting: 3,
      ...
      ...> })
      iex> result = MetaCredo.Analysis.Complexity.Result.merge([r1, r2])
  ...
  ## Examples
      ...
      ...>   function_metrics: %{}
      ...> })
      iex> result = MetaCredo.Analysis.Complexity.Result.apply_thresholds(result, %{})
