defmodule MetaCredo.Analysis.Duplication.Similarity do
  @moduledoc """
  ...
  ## Usage
      ...
      alias MetaCredo.Analysis.Duplication.Similarity
  ...
  ## Examples
      ...
      iex> MetaCredo.Analysis.Duplication.Similarity.calculate(ast1, ast2)
      1.0
      ...
      iex> score = MetaCredo.Analysis.Duplication.Similarity.calculate(ast1, ast2)
      iex> score > 0.5
      true
  """
  ...
  ## Examples
      ...
      iex> MetaCredo.Analysis.Duplication.Similarity.structural_similarity(ast1, ast2)
      1.0

      iex> ast1 = {:variable, [], "x"}
      iex> ast2 = {:variable, [], "y"}
      iex> score = MetaCredo.Analysis.Duplication.Similarity.structural_similarity(ast1, ast2)
      iex> score > 0.0
      true
  """
  ...
  ## Examples
      ...
      iex> score = MetaCredo.Analysis.Duplication.Similarity.token_similarity(ast1, ast2)
      iex> score > 0.5
      true
  """
  ...
  ## Examples
      ...
      iex> ast1 = {:literal, [subtype: :integer], 42}
      iex> ast2 = {:literal, [subtype: :integer], 42}
      iex> MetaCredo.Analysis.Duplication.Similarity.similar?(ast1, ast2, 0.8)
      true
