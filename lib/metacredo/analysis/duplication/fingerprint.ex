defmodule MetaCredo.Analysis.Duplication.Fingerprint do
  @moduledoc """
  ...
  ## Usage
      ...
      alias MetaCredo.Analysis.Duplication.Fingerprint
  ...
  ## Examples
      ...
      iex> fp = MetaCredo.Analysis.Duplication.Fingerprint.exact(ast)
      ...
      iex> fp1 = MetaCredo.Analysis.Duplication.Fingerprint.normalized(ast1)
      iex> fp2 = MetaCredo.Analysis.Duplication.Fingerprint.normalized(ast2)
      iex> fp1 == fp2
      true
  """
  ...
  ## Examples
      ...
      iex> ast1 = {:variable, [], "x"}
      iex> ast2 = {:variable, [], "x"}
      iex> MetaCredo.Analysis.Duplication.Fingerprint.exact(ast1) == MetaCredo.Analysis.Duplication.Fingerprint.exact(ast2)
      true
  ...
  ## Examples
      ...
      iex> ast1 = {:variable, [], "x"}
      iex> ast2 = {:variable, [], "y"}
      iex> MetaCredo.Analysis.Duplication.Fingerprint.normalized(ast1) == MetaCredo.Analysis.Duplication.Fingerprint.normalized(ast2)
      true
  ...
  ## Examples
      ...
      iex> ast = {:literal, [subtype: :integer], 42}
      iex> MetaCredo.Analysis.Duplication.Fingerprint.tokens(ast)
      [:literal, :integer]

      iex> ast = {:binary_op, [category: :arithmetic, operator: :+], [{:variable, [], "x"}, {:literal, [subtype: :integer], 5}]}
      iex> tokens = MetaCredo.Analysis.Duplication.Fingerprint.tokens(ast)
  ...
  ## Examples
      ...
      iex> ast = {:literal, [subtype: :integer], 42}
      iex> fp1 = MetaCredo.Analysis.Duplication.Fingerprint.exact(ast)
      iex> fp2 = MetaCredo.Analysis.Duplication.Fingerprint.exact(ast)
      iex> MetaCredo.Analysis.Duplication.Fingerprint.match?(fp1, fp2)
      true

      iex> ast1 = {:literal, [subtype: :integer], 42}
      iex> ast2 = {:literal, [subtype: :string], "hello"}
      iex> fp1 = MetaCredo.Analysis.Duplication.Fingerprint.exact(ast1)
      iex> fp2 = MetaCredo.Analysis.Duplication.Fingerprint.exact(ast2)
      iex> MetaCredo.Analysis.Duplication.Fingerprint.match?(fp1, fp2)
      false
  """
