defmodule MetaCredo.Analysis.Duplication.Types do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> MetaCredo.Analysis.Duplication.Types.type_i()
      :type_i

      iex> MetaCredo.Analysis.Duplication.Types.all_types()
  ...
  ## Examples
      ...
      iex> MetaCredo.Analysis.Duplication.Types.type_ii()
      :type_ii
  """
  ...
  ## Examples
      ...
      iex> MetaCredo.Analysis.Duplication.Types.type_iii()
      :type_iii
  """
  ...
  ## Examples
      ...
      iex> MetaCredo.Analysis.Duplication.Types.type_iv()
      :type_iv
  """
  ...
  ## Examples
      ...
      iex> MetaCredo.Analysis.Duplication.Types.describe(:type_i)
      "Exact clone (identical code)"

      iex> MetaCredo.Analysis.Duplication.Types.describe(:type_ii)
      "Renamed clone (identical structure, different identifiers)"

      iex> MetaCredo.Analysis.Duplication.Types.describe(:type_iii)
      "Near-miss clone (similar structure with modifications)"

      iex> MetaCredo.Analysis.Duplication.Types.describe(:type_iv)
  ...
  ## Examples
      ...
      iex> MetaCredo.Analysis.Duplication.Types.valid?(:type_i)
      true

      iex> MetaCredo.Analysis.Duplication.Types.valid?(:invalid)
      false
  """
