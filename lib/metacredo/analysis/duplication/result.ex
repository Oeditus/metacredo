defmodule MetaCredo.Analysis.Duplication.Result do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> result = MetaCredo.Analysis.Duplication.Result.no_duplicate()
      iex> result.duplicate?
      false

      iex> result = MetaCredo.Analysis.Duplication.Result.exact_clone()
  ...
  alias MetaCredo.Analysis.Duplication.Types
  ...
  ## Examples
      ...
      iex> result = MetaCredo.Analysis.Duplication.Result.renamed_clone()
      iex> result.duplicate?
      true
      iex> result.clone_type
      :type_ii
  ...
  ## Examples
      ...
      iex> result = MetaCredo.Analysis.Duplication.Result.near_miss_clone(0.85)
      iex> result.duplicate?
      true
      iex> result.clone_type
      :type_iii
  ...
  ## Examples
      ...
      iex> result = MetaCredo.Analysis.Duplication.Result.semantic_clone(0.9)
      iex> result.duplicate?
      true
      iex> result.clone_type
      :type_iv
  ...
  ## Examples
      ...
      iex> result = MetaCredo.Analysis.Duplication.Result.with_location(result, location)
  ...
  ## Examples
      ...
      ...> ]
      iex> result = MetaCredo.Analysis.Duplication.Result.with_locations(result, locations)
  ...
  ## Examples
      ...
      iex> result = MetaCredo.Analysis.Duplication.Result.with_fingerprints(result, fingerprints)
  ...
  ## Examples
      ...
      iex> result = MetaCredo.Analysis.Duplication.Result.with_metrics(result, metrics)
  ...
  ## Examples
      ...
      iex> result = MetaCredo.Analysis.Duplication.Result.with_difference(result, diff)
  ...
  ## Examples
      ...
      ...> ]
      iex> result = MetaCredo.Analysis.Duplication.Result.with_differences(result, diffs)
  ...
  ## Examples
      ...
      iex> result = MetaCredo.Analysis.Duplication.Result.exact_clone()
      iex> result = MetaCredo.Analysis.Duplication.Result.with_summary(result, "Custom summary")
      iex> result.summary
      "Custom summary"
  """
